...
namespace diplomat
{
  namespace capi
  {
    extern "C"
    {
      ...
      typedef struct ResultOpaque_new_result
      {
        union
        {
          diplomat::capi::ResultOpaque *ok;
          diplomat::capi::ErrorEnum err;
        };
        bool is_ok;
      } ResultOpaque_new_result;
      ResultOpaque_new_result ResultOpaque_new(int32_t i);

      typedef struct ResultOpaque_new_failing_foo_result
      {
        union
        {
          diplomat::capi::ResultOpaque *ok;
      ...
      typedef struct ResultOpaque_new_failing_bar_result
      {
        union
        {
          diplomat::capi::ResultOpaque *ok;
      ...
      typedef struct ResultOpaque_new_failing_unit_result
      {
        union
        {
          diplomat::capi::ResultOpaque *ok;
      ...
      typedef struct ResultOpaque_new_in_enum_err_result
      {
        union
        {
          diplomat::capi::ErrorEnum ok;
          diplomat::capi::ResultOpaque *err;
        };
        bool is_ok;
