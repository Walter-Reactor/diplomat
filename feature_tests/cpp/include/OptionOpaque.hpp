...
namespace diplomat
{
  namespace capi
  {
    extern "C"
    {
      ...
      typedef struct OptionOpaque_returns_result
      {
        union
        {
          diplomat::capi::OptionStruct ok;
        };
        bool is_ok;
      } OptionOpaque_returns_result;
      OptionOpaque_returns_result OptionOpaque_returns(void);

      typedef struct OptionOpaque_option_isize_result
      {
        union
        {
          intptr_t ok;
      ...
      typedef struct OptionOpaque_option_usize_result
      {
        union
        {
          size_t ok;
      ...
      typedef struct OptionOpaque_option_i32_result
      {
        union
        {
          int32_t ok;
      ...
      typedef struct OptionOpaque_option_u32_result
      {
        union
        {
          uint32_t ok;
      ...
      typedef struct OptionOpaque_accepts_option_u8_result
      {
        union
        {
          uint8_t ok;
        ...
        bool is_ok;
      } OptionOpaque_accepts_option_u8_result;
      OptionOpaque_accepts_option_u8_result OptionOpaque_accepts_option_u8(diplomat::capi::OptionU8 arg);

      typedef struct OptionOpaque_accepts_option_enum_result
      {
        union
        {
          diplomat::capi::OptionEnum ok;
        };
        bool is_ok;
      } OptionOpaque_accepts_option_enum_result;
      OptionOpaque_accepts_option_enum_result OptionOpaque_accepts_option_enum(diplomat::capi::OptionEnum_option arg);

      typedef struct OptionOpaque_accepts_option_input_struct_result
      {
        union
        {
          diplomat::capi::OptionInputStruct ok;
        };
        bool is_ok;
      } OptionOpaque_accepts_option_input_struct_result;
